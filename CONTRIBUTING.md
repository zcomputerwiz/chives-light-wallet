...
4. Hive Project's nodes on the public testnet are running the latest version `x.y.z`.
...
We provide a [pre-commit configuration](https://github.com/HiveProject2021/chives-light-wallet/blob/main/.pre-commit-config.yaml) which triggers several useful
...
6. Install these linters https://github.com/HiveProject2021/chives-light-wallet/tree/main/.github/linters
