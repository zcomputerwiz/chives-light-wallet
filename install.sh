...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	...
	echo "https://github.com/HiveProject2021/chives-light-wallet/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
			...
			if [ "$BEST_VERSION" = "" ]; then
				...
				if [ "$BEST_VERSION" = "3" ]; then
					...
					if [[ "$PY3_VERSION" =~ 3.10.* ]]; then
						echo "Chives requires Python version <= 3.9.9"
...
echo "https://github.com/HiveProject2021/chives-light-wallet/wiki/Quick-Start-Guide"
echo ""
