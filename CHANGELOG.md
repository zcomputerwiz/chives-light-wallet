...
- Performance improvements for nodes to support higher transaction volumes, especially for low powered devices like RaspBerry Pi. Full details at [#9050](https://github.com/HiveProject2021/chives-light-wallet/pull/9050).
...
- Integrated the Bladebit plotter to CLI and GUI. Thanks @harold-b for all your hard work on this, and welcome again to the Hive Project team!
...
- Switched IP address lookup to first use Chives's service ip.chia.net.
...
- Thanks to @yshklarov for help fixing [#7273](https://github.com/HiveProject2021/chives-light-wallet/issues/7273), which bundled CA store to support pools for some farming systems, including M1 Apple computers. This enables those machines to properly connect to pools, and fixes the issue.
...
- You should review the [release notes for v1.0.2](https://github.com/HiveProject2021/chives-light-wallet/releases/tag/1.0.2) but we especially want to point out that wallet sync is much faster than in 1.0.1 and earlier versions.
...
- We have added Dutch and Polish to supported translations. Thanks @psydafke, @WesleyVH, @pieterhauwaerts, @bartlomiej.tokarzewski, @abstruso, @feel.the.code, and @Axadiw for contributions to [translations on Crowdin](https://crowdin.com/project/chives-light-wallet).
...
- Translations now available for German, Traditional Chinese, and Danish. Thanks to @Dravenex, @MaestroOnICe, @loudsyncro, @loppefaaret, @thirteenthd, @wong8888, @N418, and @swjz for all the translation help. You to can translate at our [Crowdin project](https://crowdin.com/project/chives-light-wallet/).
...
- Thank you to @L3Sota for adding a Japanese translation via our [Crowdin project](https://crowdin.com/project/chives-light-wallet).
...
- Some users can't plot in the GUI in MacOS Big Sur - especially on M1. See issue [1189](https://github.com/HiveProject2021/chives-light-wallet/issues/1189)
...
- We have added Romanian to the GUI translations. Thank you to @bicilis on [Crowdin](https://crowdin.com/project/chives-light-wallet). We also added a couple of additional target languages. Klingon anyone?
...
- This is an errata release for Release Candidate 1. There were a couple of things that did not smoothly migrate from the Beta versions. Please make sure you also consult the [release notes for RC-1](https://github.com/HiveProject2021/chives-light-wallet/releases/tag/1.0rc1) was well.
...
- We have added the [Crowdin](https://crowdin.com/) translation platform to [chives blockchain gui](https://crowdin.com/project/chives-light-wallet). We are still getting it fully set up, but helping to translate the GUI is going to be much easier.
...
- Last Attempted Proof is now fixed. This will show you the last time one of your plots passed the [plot filter](https://github.com/HiveProject2021/chives-light-wallet/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it).
...
- `chives -h` now recommends `chia netspace -d 192` which is approximately one hours worth of sub blocks. Use `-d 1000` to get the same estimate of netspace as the RPC and GUI.
...
- `chia netspace -s` would not correctly look up the start block height by block hash. Additionally netspace now flips to PiB above 1024 TiB. To compare netspace to `chives show` of the GUI use `chia netspace -d 1000` as `chia netspace` defaults to `-d 192` which is one hour.
...
- In the GUI there was [a regression](https://github.com/HiveProject2021/chives-light-wallet/issues/484) that removed the scroll bar on the Plot page. The scroll bar has returned!
...
- Logging had [a regression](https://github.com/HiveProject2021/chives-light-wallet/issues/485) where log level could no longer be set by service.
...
- In Windows the start menu item is now Hive Project and the icon in Add/Remove is updated.
...
- The Windows installer is now signed by a Hive Project certificate. It may take some time to develop enough reputation to not warn multiple times during install.
...
- We now codesign the Apple .dmg installer with the Hive Project developer ID on both GitHub Actions and Azure Pipelines. We will be notarizing and distributing the Azure Pipelines version as it's built on MacOS Mojave (10.14.6) for stronger cross version support.
...
- Most of the content of README.md and INSTALL.md have been moved to the [repository wiki](https://github.com/HiveProject2021/chives-light-wallet/wiki) and placed in [INSTALL](https://github.com/HiveProject2021/chives-light-wallet/wiki/INSTALL) and [Quick Start Guide](https://github.com/HiveProject2021/chives-light-wallet/wiki/Quick-Start-Guide)
...
- We suggest you take a look at our [Upgrading documentation](https://github.com/HiveProject2021/chives-light-wallet/wiki/Updating-beta-software) if you aren't performing a new install.
...
- Plots of k>=32 are not working for farming, and some broken plots can cause a memory leak. A [workaround is available](https://github.com/HiveProject2021/chives-light-wallet/wiki/Beta-1.4-k=32-or-larger-work-around).
...
[unreleased]: https://github.com/HiveProject2021/chives-light-wallet/compare/1.0beta5...dev
[1.0beta5]: https://github.com/HiveProject2021/chives-light-wallet/compare/1.0beta4...1.0beta5
[1.0beta4]: https://github.com/HiveProject2021/chives-light-wallet/compare/1.0beta3...1.0beta4
[1.0beta3]: https://github.com/HiveProject2021/chives-light-wallet/compare/1.0beta2...1.0beta3
[1.0beta2]: https://github.com/HiveProject2021/chives-light-wallet/compare/1.0beta1...1.0beta2
[1.0beta1]: https://github.com/HiveProject2021/chives-light-wallet/compare/alpha-1.5.1...1.0beta1
[alpha 1.5.1]: https://github.com/HiveProject2021/chives-light-wallet/compare/alpha-1.5...alpha-1.5.1
[alpha 1.5]: https://github.com/HiveProject2021/chives-light-wallet/compare/alpha-1.4.1...alpha-1.5
[alpha 1.4.1]: https://github.com/HiveProject2021/chives-light-wallet/compare/alpha-1.4...alpha-1.4.1
[alpha 1.4]: https://github.com/HiveProject2021/chives-light-wallet/compare/alpha-1.3...alpha-1.4
[alpha 1.3]: https://github.com/HiveProject2021/chives-light-wallet/compare/alpha-1.2...alpha-1.3
[alpha 1.2]: https://github.com/HiveProject2021/chives-light-wallet/compare/alpha-1.1.1...alpha-1.2
[alpha 1.1.1]: https://github.com/HiveProject2021/chives-light-wallet/compare/alpha-1.1...alpha-1.1.1
[alpha 1.1]: https://github.com/HiveProject2021/chives-light-wallet/compare/alpha-1.0...alpha-1.1
[alpha 1.0]: https://github.com/HiveProject2021/chives-light-wallet/releases/tag/Alpha-1.0
