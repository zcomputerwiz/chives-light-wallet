...
from chives.daemon.server import pid_path_for_service
...
def launch_service(root_path: Path, service_command) -> Tuple[subprocess.Popen, Path]:
    ...
    print(f"Launching service with CHIVES_ROOT: {os.environ['CHIVES_ROOT']}")
...
if getattr(sys, "frozen", False):
    name_map = {
        ...
        "chives_seeder_server": "chives_seeder_server",
    }
