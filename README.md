...
* [Chives seeder](https://github.com/Chia-Network/chia-blockchain/wiki/Chives-Seeder-User-Guide), which maintains a list of reliable nodes within the Chives network via a built-in DNS server.
...
section of the
[chives-wallet repository wiki](https://github.com/Chia-Network/chia-blockchain/wiki).
