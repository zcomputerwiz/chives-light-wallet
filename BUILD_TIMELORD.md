...
required to run a [Timelord](https://github.com/Chia-Network/chives-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Chia-Network/chives-blockchain/blob/main/install-timelord.sh)
